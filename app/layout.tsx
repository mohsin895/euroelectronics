...
const SITE_URL = process.env.NEXT_PUBLIC_DOMAIN || "https://motoempirebd.com";

export const metadata: Metadata = {
  metadataBase: new URL(SITE_URL),

  title: {
    default: "MOTO EMPIRE | এক ছাদের নিচে বাইকারদের প্রয়োজনীয় সব প্রোডাক্ট",
  ...
  openGraph: {
    ...
    locale: "bn_BD",
    url: SITE_URL,
    title: "MOTO EMPIRE | এক ছাদের নিচে বাইকারদের প্রয়োজনীয় সব প্রোডাক্ট",
    description:
