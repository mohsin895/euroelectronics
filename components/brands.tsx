      ...
      return (
        <section className="py-8 px-4 md:px-6">
          <div className="max-w-7xl mx-auto p-4 border border-red-300 bg-red-50 rounded-lg text-red-700 text-sm">
            <strong>BrandSlider error:</strong> {error}. Check the browser
            console for details.
          </div>
        </section>
      );
      ...
      return (
        <section className="py-8 px-4 md:px-6">
          <div className="max-w-7xl mx-auto p-4 border border-yellow-300 bg-yellow-50 rounded-lg text-yellow-700 text-sm">
            <strong>BrandSlider:</strong> API returned no active brands. Check
            the console log for the raw response and confirm the{" "}
    ...
    <section className="py-8 md:py-10 px-4 md:px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-lg font-bold text-black">Top Brands</h2>
