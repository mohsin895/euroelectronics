        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Link
                href="/"
                className="flex items-center bg-white rounded-sm p-2 gap-2 font-bold text-lg"
              >
                <Image src="/logo.png" alt="logo" width={90} height={75} />
              </Link>
            </div>
            <p className="text-sm opacity-80">
              An e-commerce platform dedicated to providing safe and reliable
              food to every home.
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8 py-8 border-t border-white/20">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="text-sm opacity-80">
                {settings?.address || "Rampura, Dhaka, Bangladesh"}
              </div>
            </div>
          </div>
          <div className="flex items-start gap-3">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="text-sm opacity-80">
                {settings?.email || "contact@eggsspices.com"}
              </div>
            </div>
          </div>
        </div>
